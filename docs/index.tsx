import { Features, FeaturesProps, Highlighter } from '@arietta-studio/ui';
...
const example = `import { ThemeProvider, GradientButton } from '@arietta-studio/ui'

export default () => (
  <ThemeProvider>
    <GradientButton>Hello Arietta</GradientButton>
  </ThemeProvider>
)`;
...
export default () => {
  ...
  return (
    <Center gap={16}>
      <Center>
        <h2 style={{ fontSize: 20 }}>🤯 Start building your amazing app now</h2>
        <div style={{ color: theme.colorTextDescription, textAlign: 'center' }}>
          The Arietta UI components are developed based on{' '}
