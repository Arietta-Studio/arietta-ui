...
import { AriettaCustomStylish } from '@/types/customStylish';

export const generateCustomStylish: GetCustomStylish<AriettaCustomStylish> = ({
  css,
  token,
  isDarkMode,
}) => {
  ...
  return {
    ...
    `,
    markdown: css`
      --arietta-markdown-font-size: 16px;
      --arietta-markdown-header-multiple: 1;
      --arietta-markdown-margin-multiple: 1.5;
      ...
      h5 {
        margin-block: max(
          calc(
            var(--arietta-markdown-header-multiple) * var(--arietta-markdown-margin-multiple) *
              0.5em
          ),
      ...
      h1 {
        font-size: calc(
          var(--arietta-markdown-font-size) * (1 + 1.5 * var(--arietta-markdown-header-multiple))
        );
      }

      h2 {
        font-size: calc(
          var(--arietta-markdown-font-size) * (1 + var(--arietta-markdown-header-multiple))
        );
      }

      h3 {
        font-size: calc(
          var(--arietta-markdown-font-size) * (1 + 0.5 * var(--arietta-markdown-header-multiple))
        );
      }

      h4 {
        font-size: calc(
          var(--arietta-markdown-font-size) * (1 + 0.25 * var(--arietta-markdown-header-multiple))
        );
      }

      h5 {
        font-size: calc(var(--arietta-markdown-font-size) * 1);
      }

      li {
        margin-block: calc(var(--arietta-markdown-margin-multiple) * 0.5em);
      }
      ...
      hr {
        margin-block: calc(var(--arietta-markdown-margin-multiple) * 1.5em);
