export default [
  {
    content:
      'Empowering your AI dreams with Arietta Studio. Arietta Studio has 16 repositories available. Follow their code on GitHub.',
    favicon:
  ...
  {
    content: 'Meet the Arietta: Empowering your AI dreams with Arietta Studio.',
    favicon:
    ...
    title: 'Team: Arietta Studio - Lablab.ai',
  },
  {
    content:
  ...
  {
    content:
      'Log in · Sign up. See new Tweets. Opens profile photo. Follow. Click to Follow Arietta Studio. @arietta-studio. Joined June 2020.',
    favicon:
    ...
    title: 'Arietta Studio (@arietta-studio) | Twitter',
  },
  {
    content:
      'dumi-theme-arietta is a documentation site theme package designed for dumi2. It provides a more beautiful and user-friendly development and reading ...',
    favicon:
    ...
    title: 'dumi-theme-arietta - npm Package Overview - Socket',
  },
];
