  ...
  (
    ...
    return {
      __root: css`
        ...
        --arietta-markdown-border-radius: ${token.borderRadiusLG};
        --arietta-markdown-border-color: ${isDarkMode
      ...
      list: css`
        li {
          margin-block: calc(var(--arietta-markdown-margin-multiple) * 0.33em);
        }
